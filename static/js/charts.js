...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var otu_ids1 = sampleResult.otu_ids;
    var otu_labels1 = sampleResult.otu_labels;
    var sample_values1 = sampleResult.sample_values;
    // for bubble chart make sure to use these unsliced variables
    ...
    var yticks = otu_ids1.slice(0,10).map(otuID1 =>`OTU ${otuID1}`).reverse();
    console.log(yticks);
